...
var app = (function () {
    ...
    function create_if_block_4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			button1.textContent = "+";
    			attr_dev(p0, "class", "svelte-ef8xi5");
    			add_location(p0, file$5, 1001, 12, 36126);
    			attr_dev(input, "type", "text");
    			attr_dev(input, "id", "fname");
    			attr_dev(input, "name", "fname");
    			add_location(input, file$5, 1002, 12, 36155);
    			attr_dev(p1, "class", "svelte-ef8xi5");
    			add_location(p1, file$5, 1001, 24, 36138);
    			attr_dev(button0, "class", "svelte-ef8xi5");
    			add_location(button0, file$5, 1004, 16, 36257);
    			attr_dev(p2, "class", "svelte-ef8xi5");
    			add_location(p2, file$5, 1005, 16, 36318);
    			attr_dev(button1, "class", "svelte-ef8xi5");
    			add_location(button1, file$5, 1006, 16, 36366);
    			attr_dev(div0, "class", "width_buttons svelte-ef8xi5");
    			add_location(div0, file$5, 1003, 12, 36212);
    			attr_dev(div1, "class", "options_content svelte-ef8xi5");
    			add_location(div1, file$5, 1000, 8, 36083);
    			attr_dev(div2, "class", "options svelte-ef8xi5");
    			add_location(div2, file$5, 999, 4, 36052);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div2, anchor);
    			append_dev(div2, div1);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(999:4) {#if isGateSelected}",
    		ctx
    	});
    ...
    function create_if_block_3(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(1013:8) {#if isSelecting_Draw}",
    		ctx
    	});
    ...
    function create_each_block_1$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(1018:16) {#each wires as wire, i}",
    		ctx
    	});
    ...
    function create_if_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(1031:12) {#if gate.type === 'light'}",
    		ctx
    	});
    ...
    // (1030:8) {#each components as gate, i}
    function create_each_block$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(1030:8) {#each components as gate, i}",
    		ctx
    	});
    ...
    function create_fragment$6(ctx) {
    	...
    	let if_block3 = /*isPlacing*/ ctx[6] && create_if_block$3(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(svg, file$5, 1016, 12, 36776);
    			attr_dev(div0, "class", "wire svelte-ef8xi5");
    			add_location(div0, file$5, 1015, 8, 36744);
    			attr_dev(div1, "id", "zoomLayer");
    			attr_dev(div1, "class", "svelte-ef8xi5");
    			add_location(div1, file$5, 1011, 4, 36474);
    			attr_dev(div2, "class", "workspace svelte-ef8xi5");
    			add_location(div2, file$5, 997, 0, 35972);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    */
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			h26 = element("h2");
    			h26.textContent = "SWITCH";
    			t13 = space();
    			button7 = element("button");
    			h27 = element("h2");
    			h27.textContent = "LIGHT";
    			t15 = space();
    			div1 = element("div");
    			create_component(canvas_1.$$.fragment);
    			attr_dev(h20, "class", "svelte-de2jss");
    			add_location(h20, file$4, 69, 3, 1246);
    			attr_dev(button0, "class", "svelte-de2jss");
    			add_location(button0, file$4, 67, 2, 1137);
    			attr_dev(h21, "class", "svelte-de2jss");
    			add_location(h21, file$4, 73, 3, 1386);
    			attr_dev(button1, "class", "svelte-de2jss");
    			add_location(button1, file$4, 71, 2, 1275);
    			attr_dev(h22, "class", "svelte-de2jss");
    			add_location(h22, file$4, 77, 3, 1523);
    			attr_dev(button2, "class", "svelte-de2jss");
    			add_location(button2, file$4, 75, 2, 1416);
    			attr_dev(h23, "class", "svelte-de2jss");
    			add_location(h23, file$4, 81, 3, 1660);
    			attr_dev(button3, "class", "svelte-de2jss");
    			add_location(button3, file$4, 79, 2, 1551);
    			attr_dev(h24, "class", "svelte-de2jss");
    			add_location(h24, file$4, 85, 3, 1798);
    			attr_dev(button4, "class", "svelte-de2jss");
    			add_location(button4, file$4, 83, 2, 1689);
    			attr_dev(h25, "class", "svelte-de2jss");
    			add_location(h25, file$4, 89, 3, 1936);
    			attr_dev(button5, "class", "svelte-de2jss");
    			add_location(button5, file$4, 87, 2, 1827);
    			attr_dev(h26, "class", "svelte-de2jss");
    			add_location(h26, file$4, 94, 3, 2156);
    			attr_dev(button6, "class", "svelte-de2jss");
    			add_location(button6, file$4, 93, 2, 2101);
    			attr_dev(h27, "class", "svelte-de2jss");
    			add_location(h27, file$4, 97, 3, 2242);
    			attr_dev(button7, "class", "svelte-de2jss");
    			add_location(button7, file$4, 96, 2, 2188);
    			attr_dev(div0, "class", "menu svelte-de2jss");
    			add_location(div0, file$4, 66, 1, 1115);
    			attr_dev(div1, "class", "canvas svelte-de2jss");
    			add_location(div1, file$4, 124, 1, 2954);
    			attr_dev(div2, "class", "main svelte-de2jss");
    			add_location(div2, file$4, 65, 0, 1094);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	$$self.$$set = $$props => {
    		if ("applicationState" in $$props) $$invalidate(2, applicationState = $$props.applicationState);
    ...
    class LogicSim extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$5, create_fragment$5, safe_not_equal, { applicationState: 2, externalData: 0 });
    		...
    		if (/*applicationState*/ ctx[2] === undefined && !("applicationState" in props)) {
    			console.warn("<LogicSim> was created without expected prop 'applicationState'");
    		}

    		if (/*externalData*/ ctx[0] === undefined && !("externalData" in props)) {
    			console.warn("<LogicSim> was created without expected prop 'externalData'");
    		}
    	}
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = space();
    			p = element("p");
    			p.textContent = "Incomplete";
    			attr_dev(img, "class", "no_check svelte-1v73ipn");
    			if (img.src !== (img_src_value = "build/red_x.svg")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "check");
    			add_location(img, file$2, 79, 16, 1837);
    			attr_dev(p, "class", "svelte-1v73ipn");
    			add_location(p, file$2, 80, 16, 1911);
    		},
    		m: function mount(target, anchor) {
    ...
    // (75:12) {#if checkForLesson(cardInfo.lessonID)}
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "check svelte-1v73ipn");
    			if (img.src !== (img_src_value = "build/green_check.svg")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "check");
    			add_location(img, file$2, 76, 16, 1705);
    			attr_dev(p, "class", "svelte-1v73ipn");
    			add_location(p, file$2, 77, 16, 1782);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, img, anchor);
    			insert_dev(target, t0, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(75:12) {#if checkForLesson(cardInfo.lessonID)}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			if_block.c();
    			add_location(b, file$2, 72, 16, 1418);
    			attr_dev(h4, "class", "svelte-1v73ipn");
    			add_location(h4, file$2, 72, 12, 1414);
    			attr_dev(div0, "class", "container svelte-1v73ipn");
    			add_location(div0, file$2, 71, 8, 1377);
    			attr_dev(div1, "class", "slide-fwd-center");
    			add_location(div1, file$2, 70, 4, 1337);
    			attr_dev(div2, "class", "card svelte-1v73ipn");
    			add_location(div2, file$2, 69, 0, 1275);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_else_block(ctx) {
    	...
    	logicsim = new LogicSim({
    			props: {
    				applicationState: /*appState*/ ctx[2],
