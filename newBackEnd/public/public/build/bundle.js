...
var app = (function () {
    ...
    function create_if_block_4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p0, file$5, 1017, 12, 36602);
    			attr_dev(input, "type", "text");
    			attr_dev(input, "id", "fname");
    			attr_dev(input, "name", "fname");
    			add_location(input, file$5, 1018, 12, 36631);
    			attr_dev(p1, "class", "svelte-ef8xi5");
    			add_location(p1, file$5, 1017, 24, 36614);
    			attr_dev(button0, "class", "svelte-ef8xi5");
    			add_location(button0, file$5, 1020, 16, 36733);
    			attr_dev(p2, "class", "svelte-ef8xi5");
    			add_location(p2, file$5, 1021, 16, 36794);
    			attr_dev(button1, "class", "svelte-ef8xi5");
    			add_location(button1, file$5, 1022, 16, 36842);
    			attr_dev(div0, "class", "width_buttons svelte-ef8xi5");
    			add_location(div0, file$5, 1019, 12, 36688);
    			attr_dev(div1, "class", "options_content svelte-ef8xi5");
    			add_location(div1, file$5, 1016, 8, 36559);
    			attr_dev(div2, "class", "options svelte-ef8xi5");
    			add_location(div2, file$5, 1015, 4, 36528);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div2, anchor);
    			append_dev(div2, div1);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(1015:4) {#if isGateSelected}",
    		ctx
    	});
    ...
    function create_if_block_3(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(1029:8) {#if isSelecting_Draw}",
    		ctx
    	});
    ...
    function create_each_block_1$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(1034:16) {#each wires as wire, i}",
    		ctx
    	});
    ...
    function create_if_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(1047:12) {#if gate.type === 'light'}",
    		ctx
    	});
    ...
    // (1046:8) {#each components as gate, i}
    function create_each_block$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(1046:8) {#each components as gate, i}",
    		ctx
    	});
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(svg, file$5, 1032, 12, 37252);
    			attr_dev(div0, "class", "wire svelte-ef8xi5");
    			add_location(div0, file$5, 1031, 8, 37220);
    			attr_dev(div1, "id", "zoomLayer");
    			attr_dev(div1, "class", "svelte-ef8xi5");
    			add_location(div1, file$5, 1027, 4, 36950);
    			attr_dev(div2, "class", "workspace svelte-ef8xi5");
    			add_location(div2, file$5, 1013, 0, 36448);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    */
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h20, file$4, 74, 3, 1309);
    			attr_dev(button0, "class", "svelte-de2jss");
    			add_location(button0, file$4, 73, 2, 1256);
    			attr_dev(h21, "class", "svelte-de2jss");
    			add_location(h21, file$4, 78, 3, 1448);
    			attr_dev(button1, "class", "svelte-de2jss");
    			add_location(button1, file$4, 76, 2, 1339);
    			attr_dev(h22, "class", "svelte-de2jss");
    			add_location(h22, file$4, 82, 3, 1588);
    			attr_dev(button2, "class", "svelte-de2jss");
    			add_location(button2, file$4, 80, 2, 1477);
    			attr_dev(h23, "class", "svelte-de2jss");
    			add_location(h23, file$4, 86, 3, 1725);
    			attr_dev(button3, "class", "svelte-de2jss");
    			add_location(button3, file$4, 84, 2, 1618);
    			attr_dev(h24, "class", "svelte-de2jss");
    			add_location(h24, file$4, 90, 3, 1862);
    			attr_dev(button4, "class", "svelte-de2jss");
    			add_location(button4, file$4, 88, 2, 1753);
    			attr_dev(h25, "class", "svelte-de2jss");
    			add_location(h25, file$4, 94, 3, 2000);
    			attr_dev(button5, "class", "svelte-de2jss");
    			add_location(button5, file$4, 92, 2, 1891);
    			attr_dev(h26, "class", "svelte-de2jss");
    			add_location(h26, file$4, 98, 3, 2138);
    			attr_dev(button6, "class", "svelte-de2jss");
    			add_location(button6, file$4, 96, 2, 2029);
    			attr_dev(h27, "class", "svelte-de2jss");
    			add_location(h27, file$4, 103, 3, 2358);
    			attr_dev(button7, "class", "svelte-de2jss");
    			add_location(button7, file$4, 102, 2, 2303);
    			attr_dev(h28, "class", "svelte-de2jss");
    			add_location(h28, file$4, 106, 3, 2443);
    			attr_dev(button8, "class", "svelte-de2jss");
    			add_location(button8, file$4, 105, 2, 2390);
    			attr_dev(h29, "class", "svelte-de2jss");
    			add_location(h29, file$4, 111, 3, 2522);
    			attr_dev(button9, "class", "svelte-de2jss");
    			add_location(button9, file$4, 110, 2, 2478);
    			attr_dev(h210, "class", "svelte-de2jss");
    			add_location(h210, file$4, 114, 3, 2596);
    			attr_dev(button10, "class", "svelte-de2jss");
    			add_location(button10, file$4, 113, 2, 2552);
    			attr_dev(div0, "class", "menu svelte-de2jss");
    			add_location(div0, file$4, 72, 1, 1234);
    			attr_dev(div1, "class", "canvas svelte-de2jss");
    			add_location(div1, file$4, 141, 1, 3307);
    			attr_dev(div2, "class", "main svelte-de2jss");
    			add_location(div2, file$4, 71, 0, 1213);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	const click_handler_8 = () => canvas.addGate("Save");
